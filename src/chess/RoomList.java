...
public class RoomList extends JFrame {
  ...
  public RoomList(Home home, final User user) {
    ...
    btnNewButton.setBounds(631, 9, 108, 30);
    ...
    button_3.setBounds(505, 9, 93, 30);
...
*/
    ...
    textArea.setBounds(0, 0, 232, 605);
    panel_5.add(textArea);

    textField.setBounds(0, 607, 149, 25);
    ...
    btnNewButton_1.setBounds(148, 603, 79, 29);
